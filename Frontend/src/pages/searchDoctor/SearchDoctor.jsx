    ...
    const handleSearch = () => {
        ...
        if (filteredDoctor && filteredDoctor.length > 0) {
            const filteredResults = filteredDoctor.filter((doctor) => {
                ...
                const paramsName = (searchParams.name || "").toLowerCase();
                const paramsCity = (searchParams.city || "").toLowerCase();
                    ...
                    <div className="input">
                        ...
                        <div className="input-right-box">
                            ...
                            <input
                                ...
                                placeholder='e.g. Berlin or 12345'
            ...
            <div className="main-cardDoctor">
                {loading ? (
                    ...
                    <div className="flex flex-col xl:flex-row lg:flex-row  items-center">
                        ...
                        <p className='notInfo text-[35px] mt-10 text-sky-900'>No matching doctors found.</p>
                    </div>
                )}
            </div>
