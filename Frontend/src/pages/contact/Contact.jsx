...
const Contact = () => {
  ...
  return (
    <>
       <Header/>
        <div className='grid grid-rows-2  bg-[#F1F7FE] w-full lg:grid-cols-2 lg:h-[75vh]' id="contact">
        {!isSent ?
          <form onSubmit={handleSubmit} className='rows-span-1 my-8 md:mt-6 lg:mt-0 flex items-center justify-center lg:cols-span-1 lg:h-[65vh]'>
            <fieldset className='border-2 rounded-lg w-[330px] p-5 border-[#567fa9]'>
              <legend className='text-2xl text-center text-[#3d5e7f] font-bold 2xl:text-4xl'>Contact Us</legend>
          ...
          :
          <h1 className='rows-span-1 text-2xl my-8 text-center px-3 flex items-center justify-center lg:cols-span-1 lg:h-[65vh] lg:text-3xl xl:px-6'>Your message has been sent. We will get back to you as soon as possible.</h1>
        }
