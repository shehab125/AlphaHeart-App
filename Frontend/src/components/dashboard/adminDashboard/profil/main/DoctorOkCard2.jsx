...
const DoctorOkCard = ({ id, firstName,lastName, title, branch, cityName, street,zipCode,email,phone, website,languages,complaints, isApproved, about,files
}) => {
...
const fileImage = files.length > 0 ? `${URL}/uploads/${files[0].fileName}` : profileImg;
  ...
  return (
    ...
    <div className="apanel-view-doctor-btn">
      <button onClick={()=>handleShow()}>License Certificate</button>
