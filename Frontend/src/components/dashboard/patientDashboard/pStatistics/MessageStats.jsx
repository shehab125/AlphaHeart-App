...
const MessageStats = () => {
  ...
  //console.log(messages)
    ...
    data = [
      ["", "Number of Doctors", "Number of Messages"],
      ["Messages I sent", receiverDoctorsNumber, sentMessagesNumber],
      ["Messages I received", senderDoctorsNumber, receivedMessagesNumber]
    ];
