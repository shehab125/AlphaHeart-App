    ...
    <div className='d-man-tag-main flex justify-center items-center'>
        ...
        <div className='d-man-tag-create flex justify-center items-center' id="days">
            ...
            <div className="d-man-tag-title w-24 flex flex-col justify-center items-center">
                <label className="  text-gray-700 text-xs font-bold mb-2" htmlFor="grid-state">Day Start</label>
            ...
            <div className="d-man-tag-title w-24 flex flex-col justify-center items-center">
                <label className="  text-gray-700 text-xs font-bold mb-2" htmlFor="grid-state">Day End</label>
                <div className="relative">
            ...
            <div className="d-man-tag-title w-24 flex flex-col justify-center items-center">
                <label className="  text-gray-700 text-xs font-bold mb-2" htmlFor="grid-state"> Lunch Break</label>
                <div className="relative">
                    <div  className="d-man-tag-title-box appearance-none  w-[70px]  bg-white border-2 text-center border-[#d9e4f0] text-gray-700 " id="grid-state">
                        {
            ...
            <div className="d-man-tag-title w-24 flex flex-col justify-center items-center">
                <label className="d-man-tag-title-pause text-gray-700 text-xs font-bold mb-2" htmlFor="grid-state">Break End</label>
                <div className="relative">
                    <div  className="d-man-tag-title-box appearance-none  w-[70px]  bg-white border-2 text-center border-[#d9e4f0] text-gray-700 " id="grid-state">
                        {
            ...
            <div className="d-man-tag-title w-24 flex flex-col justify-center items-center">
                <label className="  text-gray-700 text-xs font-bold mb-2" htmlFor="grid-state">Appointment Duration</label>
                <div className="relative">
                    <div className="d-man-tag-title-box appearance-none  w-[70px] bg-white border-2 text-center border-[#d9e4f0] text-gray-700 " id="grid-state">
            ...
            <div>
              {/* {
                  receivedAppThisDoctor.length !== 0 ?   //!Burasi normalde calisiyor ama istersen silemeyecek sekilde düzeltirsin
                      ...
                      : */}
                      <button className='d-man-tag-btn-del w-[10rem] h-[3rem] ml-3 bg-red-600 rounded-xl text-white hover:bg-red-500 duration-150' onClick={()=>delData("weekdays", id)}>DELETE</button>
              {/* } */}
            </div>
