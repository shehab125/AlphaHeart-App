    ...
    <div className='flex ml-4 flex-col justify-center items-center max-w-[22rem] text-center'>
        {
            ...
            <div className='w-[23rem] text-center'>
                <h1 className='mt-20 text-2xl'>Your appointments are closed for this day.</h1>
            </div>
            :
            (
                !isExist ? 
                <div className='w-[20rem] text-center'>
                    ...
                    <h1 className='mt-20 text-2xl'>You have no scheduled appointments for this day.</h1>
                </div>
                :
                (termin.length ? 
                    <>
                        ...
                        <div className='flex flex-col justify-center items-center'>
                            ...
                            <h1 className='text-xl mb-2'>Date: {patient?.date}</h1>
                            <h1 className='text-xl mb-2'>Time: {patient?.timeStart}</h1>
                                ...
                                <div className='w-[18vw] ml-3'>
                                    {
                                        patient.cancelUserType === "patient" ? 
                                            <h1 className='text-red-600 mt-10 text-lg font-bold mx-auto px-10'>Appointment has been cancelled by the patient.</h1>
                                        :
                                            (
                                    ...
                                    <h1 className='text-red-600 px-10'>Cancellation reason: {patient?.cancelReason}</h1>
                                </div>
                            :
                                <div className='flex justify-evenly items-center w-[20vw] ml-3'>
                                    <button onClick={() => navigate("message")} className='mt-10 bg-sky-600 text-white text-lg py-3 px-4 rounded-xl hover:bg-sky-700 duration-150'>SEND MESSAGE</button>
                    ...
                    <div className='w-[23rem] text-center'>
                        ...
                        <h1 className='mt-20 text-2xl'>Please click on a patient name on the left to see their information.</h1>
                    </div>
                )
            )
