...
const Kalender = () => {
  ...
  let todayAppsThisDoctor = appsThisDoctor?.filter((item) => {
    return moment(item.date).format("YYYY-MM-DD") === dateToday;
  });
  ...
  const handleDateSelect = async (value) => {
    ...
    const AppsSelectedDate = appsThisDoctor?.filter((item) => {
      return moment(item.date).format("YYYY-MM-DD") === datum;
    });
...
console.log("ppppp:",patient);
  return (
    <div className="main-content calendar-main-container">
                  ...
                  <table className="bg-slate-100 mx-auto my-5 border-2 border-main-dark-blue">
                    <thead>
                      <tr>
                        ...
                        >
                          Appointments on {selectedDate || dateToday}
                        </th>
                      </tr>
                      <tr>
                    ...
                    <tbody>
                      {selectedDate === dateToday ? (
                          ...
                          return (
                            <tr key={index}>
                              ...
                              >
                                ...
                                {!item.patientId
                                  ? "Free"
                                  : (item.patientId && !item.isCancelled ? "Booked" : "Cancelled")}
                              </td>
                            </tr>
                          );
                        })
                        ...
                        <tr>
                          ...
                          >
                            Your appointments are closed on this day.
                          </td>
                        </tr>
                      )}
                    </tbody>
