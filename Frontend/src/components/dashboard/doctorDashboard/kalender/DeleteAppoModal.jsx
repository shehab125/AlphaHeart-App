...
export default function Delete({setShowModal, showModal, termin, patientInfo}) {
            ...
            <div className="relative w-auto my-6 mx-auto max-w-3xl">
              ...
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                ...
                <div className="relative p-6 flex-auto">
                    <p className="my-4 text-blueGray-500 text-lg leading-relaxed">Patient Name: <span className="font-bold">{patientInfo[0]?.firstName} {patientInfo[0]?.lastName}</span></p>
                    <p className="my-4 text-blueGray-500 text-lg leading-relaxed">Date: <span className="font-bold">{termin.date}</span></p>
                    <p className="my-4 text-blueGray-500 text-lg leading-relaxed">Time: <span className="font-bold">{termin.timeStart}</span></p>
                    <div className="relative">
                        ...
                        <label htmlFor="floating_outlined" className="absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-white dark:bg-gray-900 px-2 peer-focus:px-2 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto start-1">Cancellation Reason</label>
                    </div>
                </div>
                {/*footer*/}
