...
const Uberblick = () => {
  ...
  return (
    ...
    <div className="main-content overview-modern p-view-main h-[100vh] ">
      <div className="p-view flex rounded-3xl gap-10  justify-center">
        ...
        <div className="p-view-start flex flex-col pt-6 bg-white  w-[420px] rounded-l-3xl">
          <div className="text-4xl font-bold flex justify-center items-center border-b-8 border-main-dark-blue">
            <h1 className="text-main-dark-blue">Overview</h1>
            <svg
          ...
          <div className="flex flex-col justify-center items-center border-b-4 border-main-dark-blue mx-auto">
            ...
            <h2 className="text-3xl text-main-dark-blue my-4">Today's Appointments</h2>
          </div>
...

            {
              ...
              /></div> 
                ...
                <div className="p-view-clock bg-white h-full text-center">
                  {
                    todayAppoThisDoctor?.length ? <h1 className="text-main-dark-blue text-xl mt-10 px-6"><span className="font-bold">Note: </span>You have {todayAppoThisDoctor?.length} {todayAppoThisDoctor?.length === 1 ? "appointment" : "appointments"} today. For detailed information, please click on the name in the "Today's Appointments" section.</h1> : <h1 className="text-main-dark-blue text-xl mt-10 px-6"> <span className="font-bold">Note:</span> If you have an appointment today, please click on the name in the "Today's Appointments" section.</h1>
                  }
