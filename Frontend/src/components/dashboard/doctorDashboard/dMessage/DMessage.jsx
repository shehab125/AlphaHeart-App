...
const DMessage = ({ doctorProfile}) => {
    ...
    const messageAvatar = doctorProfile.avatar && `${URL}/uploads/${doctorProfile.avatar}`; 
    const messageAvatar2 = patientInfo.avatar && `${URL}/uploads/${patientInfo.avatar}`;
                ...
                <div className="p-message-findDoctor-main" >
                    {loading ? (
                        ...
                        <div className="p-message-findDoctor-info-main">
                            <div className="p-message-findDoctor-info-title">  <h1 >Message Service</h1></div>
                            ...
                            <div className="p-message-findDoctor-info">
                                ...
                                <div className="p-message-findDoctor-info-right">
                                    <p className="p-message-findDoctor-info-text">
                                        You can find the doctor you are looking for in the search engine.
                                    </p><p className="p-message-findDoctor-info-text">
                                        Below you can access your latest messages and quickly find the doctors from whom you have sent and received messages.
                                    </p>
                                </div>
