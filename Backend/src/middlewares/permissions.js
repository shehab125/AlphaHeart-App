...
module.exports = {
    ...
    isStaff: (req, res, next) => {
        console.log("isStaff middleware reached!");
    ...
    isAdmin: (req, res, next) => {
        console.log("isAdmin middleware reached!");
    ...
    isAdminOrDoctor: (req, res, next) => {
        console.log("isAdminOrDoctor middleware reached!");
    ...
    isAdminOrPatient: (req, res, next) => {
        console.log("isAdminOrPatient middleware reached!");
